...
public class ResourceManager {
	...
	public static void loadAllResources() {
		...
		ResourceManager.loadResource("speed", new Texture(Gdx.files.internal("powerups/speed.png")));
		ResourceManager.loadResource("life", new Texture(Gdx.files.internal("powerups/life.png")));
	}
