...
public class Player extends Character {
	...
	private void createAnimations() {
		...
		leftAnimation = new Animation<TextureRegion>(0.15f, rightFrames);
		...
		upAnimation = new Animation<TextureRegion>(0.15f, rightFrames);
		...
		downAnimation = new Animation<TextureRegion>(0.15f, rightFrames);
		...
		explosionAnimation = new Animation<TextureRegion>(0.2f, rightFrames);
	}
